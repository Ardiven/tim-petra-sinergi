...
<!-- text/x-generic login.php ( PHP script, ASCII text ) -->
<?php
if (!isset($_SESSION)) {
  session_start();
}
...
<head>
  ...
  <style>
    ...
    html {
      ...
      /*background: rgb(77,77,77);
    background: linear-gradient(180deg, rgba(77,77,77,1) 0%, rgba(0,212,255,1) 100%);*/
    }
    body {
    ...
    <div id="formContent">
      ...
      <form action="checkLogin.php" method="POST">
        <select name="jenis" class='form-control' id="jenis">
          <!--<option value = 'servantleader'>Matkul Servant Leader</option>--> 
          <!--<option value = 'calonastor'>Pendaftar Calon Astor</option>        -->
          <option value='astor' selected>Calon Asisten Tutor (Castor)</option>
          <option value='mentorgrace'>Mentor Grace</option>
          <option value='mentorlife'>Mentor Life</option>
          <!-- <option value = 'timpetrasinergi'>Pengurus TPS</option> -->
          <!-- <option value = 'leg'>Sekret LEG</option> -->
          <option value='eelife'>Mahasiswa Baru LE Life</option>
          <!-- <option value ='maba'>Mahasiswa Baru</option> -->
...
<script>
  $(document).ready(function() {
    $('select').on('change', function() {
      var jenis = $('#jenis').val();
      if (jenis == "astor") {
        $("#username").attr("placeholder", "Masukkan NRP saja");
        $("#password").attr("placeholder", "Masukkan Password SIM");
      } else if (jenis == "mentorgrace") {
        $("#username").attr("placeholder", "Masukkan Email");
        $("#password").attr("placeholder", "Masukkan Password");
      } else if (jenis == "mentorlife") {
        $("#username").attr("placeholder", "Masukkan Email");
        $("#password").attr("placeholder", "Masukkan Password");
